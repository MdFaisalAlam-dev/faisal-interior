...
const TestimonialData = [
  {
    ...
    text: "Absolutely love the design! My room feels like a luxury suite now.",
    delay: 0.2,
  },
  {
    id: 2,
    ...
    text: "Stylish, durable, and exactly what I envisioned. Five stars!",
    delay: 0.4,
  },
  {
    id: 3,
    ...
    text: "Great quality at a price I could actually afford. Highly recommend!",
    delay: 0.6,
  },
];
const Testimonial = () => {
