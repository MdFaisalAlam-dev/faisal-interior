...
const ServiceCard = [
  {
    ...
    description:
      "Luxury interiors offer premium comfort, smart tech, and timeless elegance.",
    icon: <FaVectorSquare />,
    link: "#",
    delay: 0.2,
  },
  {
    ...
    description:
      "Quality products bring durability, style, and lasting value to every space.",
    icon: <FaPenToSquare />,
    link: "#",
    delay: 0.4,
  },
  {
    ...
    description:
      "Affordable prices meet great design—style that fits your space and your budget.",
